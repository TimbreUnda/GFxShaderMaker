...
internal class ShaderVersion_SM30 : ShaderVersion_D3DCommon
{
	public ShaderVersion_SM30(ShaderPlatform platform, string id)
		: base(platform, id)
	{
	}
	...
	public override string GetShaderProfile(ShaderPipeline pipeline)
	{
		...
		{
			ShaderPipeline.PipelineType.Fragment => "ps_3_0", 
			ShaderPipeline.PipelineType.Vertex => "vs_3_0", 
			_ => null, 
		};
	}
